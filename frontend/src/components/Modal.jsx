...
const Modal = ({ title, message, onConfirm, onCancel }) => {
    ...
    return (
        <div className="fixed z-[2000] left-0 top-0 w-full h-full bg-[rgba(0,0,0,0.8)] backdrop-blur-xl animate-[fadeIn_0.2s_ease] flex items-center justify-center p-4">
            <div className="bg-bg-secondary/95 backdrop-blur-2xl border border-border-color/50 rounded-2xl shadow-xl max-w-[500px] w-full max-h-[90vh] overflow-hidden animate-[slideUp_0.3s_cubic-bezier(0.4,0,0.2,1)] flex flex-col md:w-full">
                <div className="p-6 border-b border-border-color/50 bg-gradient-to-r from-bg-tertiary to-bg-tertiary/50 md:p-5">
                ...
                <div className="p-5 border-t border-border-color/50 bg-bg-tertiary/30 flex gap-3 justify-end md:p-4 md:flex-col">
                    <button 
