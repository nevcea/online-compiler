            ...
            <main className="container">
                <div className="max-w-[900px] mx-auto py-8 md:py-6">
                           ...
                           <div className="flex flex-col gap-6">
                               <div className="bg-bg-secondary/80 backdrop-blur-sm border border-border-color rounded-xl p-8 shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-accent-primary/10 hover:border-accent-primary/30 hover:-translate-y-1 md:p-6 relative group/section overflow-hidden">
